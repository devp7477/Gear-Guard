...
-- Profiles table (for Clerk users - no foreign key to auth.users)
...
CREATE TABLE equipment (
  ...
  default_technician_id TEXT REFERENCES profiles(id) ON DELETE SET NULL,
...
CREATE TABLE maintenance_requests (
  ...
  assigned_technician_id TEXT REFERENCES profiles(id) ON DELETE SET NULL,
...
CREATE TABLE maintenance_history (
  ...
  performed_by_id TEXT REFERENCES profiles(id) ON DELETE SET NULL,
  notes TEXT,
  created_at TIMESTAMPTZ DEFAULT NOW()
);
...
CREATE POLICY "Authenticated users can create teams" ON maintenance_teams FOR INSERT WITH CHECK (true);
CREATE POLICY "Authenticated users can update teams" ON maintenance_teams FOR UPDATE USING (true);
CREATE POLICY "Authenticated users can delete teams" ON maintenance_teams FOR DELETE USING (true);

-- Team members policies
CREATE POLICY "Everyone can view team members" ON team_members FOR SELECT USING (true);
CREATE POLICY "Authenticated users can add team members" ON team_members FOR INSERT WITH CHECK (true);
CREATE POLICY "Authenticated users can remove team members" ON team_members FOR DELETE USING (true);

-- Equipment policies
CREATE POLICY "Everyone can view equipment" ON equipment FOR SELECT USING (true);
CREATE POLICY "Authenticated users can create equipment" ON equipment FOR INSERT WITH CHECK (true);
CREATE POLICY "Authenticated users can update equipment" ON equipment FOR UPDATE USING (true);
CREATE POLICY "Authenticated users can delete equipment" ON equipment FOR DELETE USING (true);

-- Maintenance requests policies
CREATE POLICY "Everyone can view requests" ON maintenance_requests FOR SELECT USING (true);
CREATE POLICY "Authenticated users can create requests" ON maintenance_requests FOR INSERT WITH CHECK (true);
CREATE POLICY "Authenticated users can update requests" ON maintenance_requests FOR UPDATE USING (true);
CREATE POLICY "Authenticated users can delete requests" ON maintenance_requests FOR DELETE USING (true);

-- Maintenance history policies
CREATE POLICY "Everyone can view history" ON maintenance_history FOR SELECT USING (true);
CREATE POLICY "Authenticated users can create history" ON maintenance_history FOR INSERT WITH CHECK (true);

-- Comments policies
CREATE POLICY "Everyone can view comments" ON maintenance_comments FOR SELECT USING (true);
CREATE POLICY "Authenticated users can create comments" ON maintenance_comments FOR INSERT WITH CHECK (true);
CREATE POLICY "Users can update own comments" ON maintenance_comments FOR UPDATE USING (true);
CREATE POLICY "Users can delete own comments" ON maintenance_comments FOR DELETE USING (true);

-- Notifications policies
CREATE POLICY "Users can view own notifications" ON maintenance_notifications FOR SELECT USING (true);
CREATE POLICY "Authenticated users can create notifications" ON maintenance_notifications FOR INSERT WITH CHECK (true);
CREATE POLICY "Users can update own notifications" ON maintenance_notifications FOR UPDATE USING (true);
CREATE POLICY "Users can delete own notifications" ON maintenance_notifications FOR DELETE USING (true);
